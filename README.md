...
| [`3. Cinematica_Directa`](./3.%20Cinematica_Directa) | Desarrollo y cálculo de la cinemática directa del robot, resuelta por dos métodos independientes (Matrices de Transformación Homogénea y Denavit–Hartenberg) que se contrastan entre sí. |
| [`4. Cinematica_Inversa`](./4.%20Cinematica_Inversa) | Desarrollo y cálculo de la cinemática inversa del robot mediante desacoplamiento geométrico (ley de cosenos para $\theta_1,\theta_2$ y despeje directo para $d_3$). |
